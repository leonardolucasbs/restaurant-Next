...
Menu.tsx chama useMenuFilter() para obter o estado dos filtros
FilterButtons.tsx renderiza os botões de filtro
Quando o usuário clica em um botão, onCategoryChange() é disparado
O hook useMenuFilter() filtra os pratos baseado na categoria
Menu.tsx renderiza os pratos filtrados usando PlateCard.tsx para cada um
🎨 Estilo
